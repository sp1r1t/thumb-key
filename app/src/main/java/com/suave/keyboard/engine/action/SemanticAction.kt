 ...
 * gesture -> intent -> modifier lane (via [com.suave.keyboard.engine.modifier.ResolvedIntent]),
 * while [MoveCursor]/[ExtendSelection] come directly from the continuous slide lane
 * ([com.suave.keyboard.engine.gesture.Gesture.SlideStep] bypasses intent/modifier entirely - sliding
