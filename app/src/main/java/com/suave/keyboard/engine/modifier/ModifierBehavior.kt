 ...
 * - [actsAsModifier]: when false, a [com.suave.keyboard.engine.intent.KeyIntent.ModifierPress] is
 *   rewritten to that modifier's [com.suave.keyboard.engine.intent.ModifierId.standaloneCommand] and
