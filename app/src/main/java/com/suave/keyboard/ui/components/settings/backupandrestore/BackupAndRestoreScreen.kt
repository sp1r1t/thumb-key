package com.suave.keyboard.ui.components.settings.backupandrestore
...
import com.suave.keyboard.db.DEFAULT_CLIPBOARD_AUTO_CLEANUP_ENABLED
import com.suave.keyboard.db.DEFAULT_CLIPBOARD_CLEANUP_AFTER_MINUTES
import com.suave.keyboard.db.DEFAULT_CLIPBOARD_HISTORY_ENABLED
import com.suave.keyboard.db.DEFAULT_CLIPBOARD_MAX_SIZE
import com.suave.keyboard.db.DEFAULT_CLIPBOARD_SIZE_LIMIT_ENABLED
...
import com.suave.keyboard.db.DEFAULT_HIDE_KEY_CATEGORIES
...
import com.suave.keyboard.db.DEFAULT_SHOW_TOAST_ON_LAYOUT_SWITCH
import com.suave.keyboard.db.DEFAULT_SPACEBAR_MULTITAPS
import com.suave.keyboard.db.DEFAULT_THEME
import com.suave.keyboard.db.DEFAULT_THEME_COLOR
import com.suave.keyboard.db.DEFAULT_CAPTURE_SYSTEM_CLIPBOARD
...
import com.suave.keyboard.utils.updateLayouts
...
private fun resetAppSettingsToDefault(appSettingsViewModel: AppSettingsViewModel) {
    ...
    appSettingsViewModel.update(
        AppSettings(
            ...
            clipboardImagesEnabled = DEFAULT_CLIPBOARD_IMAGES_ENABLED,
