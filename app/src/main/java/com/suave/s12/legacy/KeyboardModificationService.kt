...
import com.suave.s12.legacy.keyboards.BACKSPACE_KEYC
import com.suave.s12.legacy.keyboards.BACKSPACE_TEXT_MANIPULATION_KEYC
import com.suave.s12.legacy.keyboards.COPY_KEYC
import com.suave.s12.legacy.keyboards.CUT_KEYC
import com.suave.s12.legacy.keyboards.DELETE_WORD_AFTER_CURSOR_KEYC
import com.suave.s12.legacy.keyboards.DELETE_WORD_BEFORE_CURSOR_KEYC
import com.suave.s12.legacy.keyboards.GOTO_SETTINGS_KEYC
import com.suave.s12.legacy.keyboards.HIDE_KEYBOARD_KEYC
import com.suave.s12.legacy.keyboards.NEXT_WORD_AFTER_CURSOR_KEYC
import com.suave.s12.legacy.keyboards.NOOP_KEYC
import com.suave.s12.legacy.keyboards.PASTE_KEYC
import com.suave.s12.legacy.keyboards.PREVIOUS_WORD_BEFORE_CURSOR_KEYC
import com.suave.s12.legacy.keyboards.REDO_KEYC
import com.suave.s12.legacy.keyboards.RETURN_KEYC
import com.suave.s12.legacy.keyboards.SELECT_ALL_KEYC
import com.suave.s12.legacy.keyboards.SPACEBAR_LEFT_KEYC
import com.suave.s12.legacy.keyboards.SPACEBAR_PROGRAMMING_BOTTOM_KEYC
import com.suave.s12.legacy.keyboards.SPACEBAR_PROGRAMMING_TOP_KEYC
import com.suave.s12.legacy.keyboards.SPACEBAR_RIGHT_KEYC
import com.suave.s12.legacy.keyboards.SWITCH_IME_KEYC
import com.suave.s12.legacy.keyboards.SWITCH_IME_VOICE_KEYC
import com.suave.s12.legacy.keyboards.SWITCH_LANGUAGE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_ALT_FALSE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_ALT_TRUE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_CAPS_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_CLIPBOARD_MODE_TRUE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_CTRL_FALSE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_CTRL_TRUE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_EMOJI_MODE_TRUE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_NUMERIC_MODE_FALSE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_NUMERIC_MODE_TRUE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_SHIFT_FALSE_KEYC
import com.suave.s12.legacy.keyboards.TOGGLE_SHIFT_TRUE_KEYC
import com.suave.s12.legacy.keyboards.UNDO_KEYC
import com.suave.s12.legacy.utils.KeyAction.CommitText
import com.suave.s12.legacy.utils.KeyAction.Noop
import com.suave.s12.legacy.utils.KeyDisplay.TextDisplay
import com.suave.s12.utils.TAG
import com.suave.s12.legacy.utils.KeyboardDefinitionModes
import com.suave.s12.legacy.utils.KeyAction
import com.suave.s12.legacy.utils.KeyC
import com.suave.s12.legacy.utils.KeyItemC
import com.suave.s12.legacy.utils.KeyboardC
...
import com.suave.s12.legacy.utils.KeyDisplay
import com.suave.s12.legacy.utils.SlideType
import com.suave.s12.legacy.utils.SwipeNWay
// Arrow Optics lenses are generated as Companion extensions in utils; star-import them.
import com.suave.s12.legacy.utils.action
import com.suave.s12.legacy.utils.arr
import com.suave.s12.legacy.utils.backgroundColor
import com.suave.s12.legacy.utils.bottom
import com.suave.s12.legacy.utils.bottomLeft
import com.suave.s12.legacy.utils.bottomRight
import com.suave.s12.legacy.utils.capsModeDisplay
import com.suave.s12.legacy.utils.center
import com.suave.s12.legacy.utils.color
import com.suave.s12.legacy.utils.display
import com.suave.s12.legacy.utils.left
import com.suave.s12.legacy.utils.longPress
import com.suave.s12.legacy.utils.modes
import com.suave.s12.legacy.utils.right
import com.suave.s12.legacy.utils.size
import com.suave.s12.legacy.utils.slideType
import com.suave.s12.legacy.utils.swipeReturnAction
import com.suave.s12.legacy.utils.swipeType
import com.suave.s12.legacy.utils.top
import com.suave.s12.legacy.utils.topLeft
import com.suave.s12.legacy.utils.topRight
import com.suave.s12.legacy.utils.widthMultiplier
import com.suave.s12.legacy.utils.alted
import com.suave.s12.legacy.utils.ctrled
import com.suave.s12.legacy.utils.main
import com.suave.s12.legacy.utils.numeric
import com.suave.s12.legacy.utils.shifted
